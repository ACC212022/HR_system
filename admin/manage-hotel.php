...
<div class="main-content">
    <div class="wrapper">
        ...
        <br /><br />
                ...
                <!-- Button to Add Admin -->
                <a href="<?php echo SITEURL; ?>admin/add-hotel.php" class="btn-primary">Add Hotel</a>
                ...
                <table class="tbl-full">
                    ...
                    <?php 
                                    ...
                                    <td>
                                        <?php  
                                            ...
                                            else
                                            {
                                                ...
                                                ?>
                                                <img src="<?php echo SITEURL; ?>images/hotel/<?php echo $image_name; ?>" width="100px">
                                                <?php
                                            }
                                        ?>
                                    </td>
                        ...
                        else
                        {
                            ...
                            echo "<tr> <td colspan='7' class='error'> Hotel not added yet. </td> </tr>";
                        }
